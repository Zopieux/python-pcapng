...
def test_read_block_interface_stats_bigendian():
    scanner = FileScanner(io.BytesIO(
       ...
       b'\x00\x00\x00\x20'  # Block size (32 bytes)
        ...
        b'\x00\x01\x00\x0aA comment\x00\x00\x00'
        b'\x00\x02\x00\x08\x00\x05\x0b\x5f\x64\xa6\xb9\x80'  # isb_starttime
        b'\x00\x03\x00\x08\x00\x05\x0b\x5f\x6b\x44\x73\x40'  # isb_endtime
        b'\x00\x04\x00\x08\x00\x00\x00\x00\x00\x01\x23\x45'  # isb_ifrecv
        b'\x00\x05\x00\x08\x00\x00\x00\x00\x00\x00\x00\x20'  # isb_drop
        b'\x00\x06\x00\x08\x00\x00\x00\x00\x00\x00\x0a\xbc'  # isb_filteraccept  # noqa
        b'\x00\x07\x00\x08\x00\x00\x00\x00\x00\x00\x00\x33'  # isb_osdrop
        b'\x00\x08\x00\x08\x00\x00\x00\x00\x00\x0a\xbc\xde'  # isb_usrdeliv
